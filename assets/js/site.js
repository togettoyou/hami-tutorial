...
/** GitHub 标识（官方 16px mark），内联避免额外请求 */
const GH_MARK = '<svg viewBox="0 0 16 16" width="17" height="17" aria-hidden="true" focusable="false">' +
  ...
  '0 0 .67-.21 2.2.82a7.65 7.65 0 0 1 2-.27c.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 ' +
  '2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8z"/>' +
  '</svg>';
...
function buildSidebar() {
  ...
  let html = `
    <div class="brand">
      <a class="brand-home" href="${home}">
        <h1>HAMi 源码导读</h1>
        <div class="sub">${SOURCE.version} @ ${SOURCE.short}</div>
      </a>
      <a class="brand-gh" href="https://github.com/${SOURCE.tutorial}"
         target="_blank" rel="noopener"
         title="本教程仓库 · GitHub" aria-label="本教程仓库 · GitHub">${GH_MARK}</a>
    </div>
